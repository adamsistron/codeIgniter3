	...
	<ul>
		<li><?php
			...
			if( isset( $auth_user_id ) ){
				...
				echo anchor( site_url('', $link_protocol ),'Login');//echo anchor( site_url(LOGIN_PAGE . '?redirect=examples', $link_protocol ),'Login','id="login-link"');
			}
		?></li>
		<?php 
			if( ! isset( $auth_user_id ) ){
		...
		<li>
			<?php echo anchor( site_url('examplesGC', $link_protocol ),'Transaccional'); ?>
		</li>
	</ul>
</div>
